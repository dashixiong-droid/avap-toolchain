## AVAP 播放测试
## 开发模式：直接解码 ProRes 4444 MOV（带 alpha）
...
func _ready() -> void:
	...
	# 开发模式：直接解码 MOV 视频
	_cache.load_video("res://assets_videos/explosion.mov")
	_cache.load_video("res://assets_videos/sparkle.mov")
	_cache.load_video("res://assets_videos/slash.mov")
	_cache.load_video("res://assets_videos/shield.mov")
	_cache.load_video("res://assets_videos/fire_ring.mov")
	_cache.load_video("res://assets_videos/heal_effect.mov")
	_cache.load_video("res://assets_videos/aura_loop.mov")
